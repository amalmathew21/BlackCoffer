...
// Create bar charts for the statistics
createBarChart("intensity-chart", statsData);
createBarChart("likelihood-chart", statsData);
createBarChart("relevance-chart", statsData);
